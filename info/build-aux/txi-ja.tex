...
\gdef\putwordTOC{目次}
% And for MODIFIED VERSION, texinfo-modified.tex
\gdef\putwordChapterPre{} % "第"をつけるなら "\gdef\putwordChapterPre{第@tie }" と定義すること。
\gdef\putwordChapterSuf{章}
\gdef\putwordSectionPre{} % "第"について同上。
\gdef\putwordSectionSuf{節}
\gdef\putwordAppendixPre{付録}
\gdef\putwordAppendixChapterSuf{章}
\gdef\putwordAppendixSectionSuf{章}
\gdef\putwordSeeSuf{参照}
%
\gdef\putwordMJan{1月}
\gdef\putwordMFeb{2月}
\gdef\putwordMMar{3月}
