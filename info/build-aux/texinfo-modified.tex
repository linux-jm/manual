...
%
%MODIFIED
\def\pxref{\xrefXX} %\def\pxref{\putwordsee{} \xrefXX}
\def\xref{\xrefXX}  %\def\xref{\putwordSee{} \xrefXX}
\def\ref{\xrefXX}
...
\def\Ynumbered{%
  \ifnum\secno=0
    \putwordChapterPre\the\chapno \putwordChapterSuf{}%
  \else \ifnum\subsecno=0
    \putwordSectionPre\the\chapno.\the\secno \putwordSectionSuf{}%
  \else \ifnum\subsubsecno=0
    \putwordSectionPre\the\chapno.\the\secno.\the\subsecno \putwordSectionSuf{}%
  \else
    \putwordSectionPre\the\chapno.\the\secno.\the\subsecno.\the\subsubsecno \putwordSectionSuf{}%
  \fi\fi\fi
}
%MODIFIED
\def\Yappendix{%
  \ifnum\secno=0
     \putwordAppendixPre@char\the\appendixno{} \putwordAppendixChapterSuf{}%
  \else \ifnum\subsecno=0
     \putwordSectionPre@char\the\appendixno.\the\secno \putwordSectionSuf{}%
  \else \ifnum\subsubsecno=0
    \putwordSectionPre@char\the\appendixno.\the\secno.\the\subsecno \putwordSectionSuf{}%
  \else
    \putwordSectionPre%
      @char\the\appendixno.\the\secno.\the\subsecno.\the\subsubsecno \putwordSectionSuf{}%
  \fi\fi\fi
}
