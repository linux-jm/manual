...
<UL>
 ...
 <LI>JM で配布する manpage の文字コードを EUC-JP から UTF-8 に変更しました。<SMALL>(2012/04/10)</SMALL>
 <UL>
 ...
 <LI>_LINK(20001120.html,LDP man-pages 翻訳完了のお知らせ)
  (2000/11/20)</LI>

 <LI>_LINK(19991015.html,Web サイトリニューアルのお知らせ)
  (1999/10/15)</LI>
</UL>
