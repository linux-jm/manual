...
m4_dnl ML2CVS ADD HERE
 ...
 <DL>
  <DT>man</DT>
  <DD>
   _UPD_PAGE(man, apropos.1)
   _UPD_PAGE(man, whatis.1)
   _UPD_PAGE(man, man.1)
   _UPD_PAGE(man, man.conf.5)
   _UPD_PAGE(man, makewhatis.8)
  </DD>
 </DL>
 ...
 <DL>
  <DT>LDP_man-pages</DT>
  <DD>
   _NEW_PAGE(LDP_man-pages, credentials.7)
